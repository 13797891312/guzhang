...
public class IphoneTreeView_stockinfo extends ExpandableListView implements
		OnScrollListener, OnGroupClickListener {
	public IphoneTreeView_stockinfo(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public IphoneTreeView_stockinfo(Context context, AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}

	public IphoneTreeView_stockinfo(Context context) {
		super(context);
		registerListener();
	}
...
//		}
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		if (loadMoreListener!=null&&isBottem&&!isLoadMore&&scrollState==0&&isUpTouch) {
			isLoadMore=true;
