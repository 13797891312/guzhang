...
public class GetPwdActivity extends BaseActivity implements OnClickListener,
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 100:
                    ...
                    break;
                case 101:
                    Toast.makeText(GetPwdActivity.this, "获取验证码失败", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    public void backClick(View v) {
        ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE))
                .hideSoftInputFromWindow(GetPwdActivity.this.getCurrentFocus()
