...
public class TreeAdapter extends BaseExpandableListAdapter implements
	...
	public TreeAdapter(Context context, IphoneTreeView iphoneTreeView, ArrayList<String> groups, HashMap<String, ArrayList<String>> mMap) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		// TODO Auto-generated method stub
			convertView = View.inflate(context,
					R.layout.item_trends_listview,null);
		return convertView;
	}
