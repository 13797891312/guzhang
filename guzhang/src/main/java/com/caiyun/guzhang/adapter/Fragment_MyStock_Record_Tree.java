...
public class Fragment_MyStock_Record_Tree extends BaseExpandableListAdapter implements
	...
	public Fragment_MyStock_Record_Tree(Context context,IphoneTreeView iphoneTreeView,ArrayList<String> groups,HashMap<String, ArrayList<String>> mMap) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		// TODO Auto-generated method stub
			convertView = View.inflate(context,
					R.layout.item_mystock_record_listview,null);
		return convertView;
	}
