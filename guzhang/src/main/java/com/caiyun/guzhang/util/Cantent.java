...
public class Cantent {
	...
	public static final int REQUST_CAMARE=1;
	public static final int REQUST_PHOTOSELECT=2;
	public static final int REQUST_CLIP=3;
	...
	public static final int VIEWPAGER_ID_PEOPLEINFO = 106;
