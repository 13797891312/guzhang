...
import com.caiyun.guzhang.view.VerticalImageSpan;
...
public class ExpressionUtil {
	...
	public static void dealExpression(Context context,
		...
		while (matcher.find()) {
			...
			Field field = R.drawable.class.getDeclaredField(key.substring(1,key.length()-1));
			...
			if (resId != 0) {
				...
				VerticalImageSpan imageSpan = new VerticalImageSpan(context, small(bitmapTemp)); // 通过图片资源id来得到bitmap，用一个ImageSpan来包装
