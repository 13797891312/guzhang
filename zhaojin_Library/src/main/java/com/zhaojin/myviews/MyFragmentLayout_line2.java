 ...
 * 
 */
public class MyFragmentLayout_line2 extends LinearLayout implements
	...
	public MyFragmentLayout_line2(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		this.context = (FragmentActivity) context;
	}

	public MyFragmentLayout_line2(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		this.context = (FragmentActivity) context;
	}
			...
			public boolean onPreDraw() {
				...
				if (resId == 0) {
					...
					FrameLayout.LayoutParams vParams = new FrameLayout.LayoutParams(
							lineWidth,tabHeight,
							Gravity.BOTTOM);
					vParams.setMargins((tabWidth-lineWidth)/2,0,(tabWidth-lineWidth)/2,marginBottum);
					v.setLayoutParams(vParams);
...
//			((ViewGroup) list.get(position).getView()).removeAllViews();
	...
	public void onPageScrolled(int arg0, float arg1, int arg2) {
		// TODO Auto-generated method stub
		MyFragmentLayout_line2.this.v.setX(arg0 * tabWidth + tabWidth * arg1+(tabWidth-lineWidth)/2);
